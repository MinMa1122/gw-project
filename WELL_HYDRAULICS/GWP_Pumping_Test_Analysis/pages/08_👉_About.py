...
with left_co1:
    st.image('WELL_HYDRAULICS/GWP_Pumping_Test_Analysis/assets/images/iNUX_wLogo.png')
with cent_co1:
    st.image('WELL_HYDRAULICS/GWP_Pumping_Test_Analysis/assets/images/1200px-Erasmus+_Logo.svg.png')
...
with left_co2:
    st.image('WELL_HYDRAULICS/GWP_Pumping_Test_Analysis/assets/images/thomasreimann.png')
with cent_co2:
    st.markdown(
        """
...
with left_co3:
    st.image('WELL_HYDRAULICS/GWP_Pumping_Test_Analysis/assets/images/eileen.poeter.jpg')
with cent_co3:
    st.markdown(
        """
