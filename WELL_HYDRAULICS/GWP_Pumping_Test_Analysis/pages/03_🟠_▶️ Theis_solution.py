...
with st.expander('**:red[Click here]** to see one **example of the curve fitting to the :red[ideal] drawdown data**'):
    ...
    with cent_co2:
        st.image('WELL_HYDRAULICS/GWP_Pumping_Test_Analysis/assets/images/Theis_Ideal_example.png', caption="One acceptable match of the Theis curve to the drawdown data") 
...
with st.expander('**:red[Click here]** to see one **example of the curve fitting to the :green[Varnum field site (Sweden)] data**'):
    ...
    left_co2, cent_co2, last_co2 = st.columns((20,60,20))
    with cent_co2:
        st.image('WELL_HYDRAULICS/GWP_Pumping_Test_Analysis/assets/images/Theis_Varnum_example.png', caption="One example for a curve match of the Theis solution to the Varnum data") 
